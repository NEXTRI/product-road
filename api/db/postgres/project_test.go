...
func TestProjectRepository_CreateProject(t *testing.T) {
	...
	mock.ExpectQuery("INSERT INTO projects \\(user_id, name, description, created_at, updated_at\\) VALUES \\(\\$1, \\$2, \\$3, \\$4, \\$5\\) RETURNING id").
		WithArgs(project.UserID, project.Name, project.Description, project.CreatedAt, project.UpdatedAt).
		WillReturnRows(rows)
